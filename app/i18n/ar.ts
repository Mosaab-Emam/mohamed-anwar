...
const ar: Translations = {
  ...
  pdfLinkEditorScreen: {
    ...
    linkAllResults: "ربط جميع النتائج",
    ...
    deleteLinkConfirmTitle: "حذف هذا الرابط؟",
    deleteLinkConfirmMessage:
      "ستُزال منطقة الرابط من ملف PDF. لا يمكن التراجع إلا بإضافة رابط من جديد.",
    addDestination: "إضافة وجهة",
    destinationGroupLabel: "الوجهة {{index}}",
    removeDestinationGroupA11y: "إزالة الوجهة {{index}}",
    saveInfo: "حفظ المعلومة",
    destinationTitleLabel: "عنوان الوجهة",
    destinationPageLabel: "رقم الصفحة",
    destinationTitlePlaceholder: "عنوان الوجهة",
    destinationPagePlaceholder: "مثل 1",
    infoFieldLabel: "نص المعلومة",
    infoPlaceholder: "نص المعلومة...",
    createdLinksCount: "تم إنشاء {{count}} روابط",
  },
  qrScannerScreen: {
    title: "ماسح QR",
