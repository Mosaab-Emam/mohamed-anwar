...
const en = {
  ...
  pdfViewerScreen: {
    ...
    qrSaved: "QR code saved to gallery",
    qrError: "Failed to generate or save QR code",
  ...
  pdfLinkEditorScreen: {
    ...
    linkAllResults: "Link all results",
    ...
    deleteLinkConfirmMessage:
      "The link area will be removed from the PDF. This cannot be undone from here without re-adding the link.",
    addDestination: "Add destination",
    destinationGroupLabel: "Destination {{index}}",
    removeDestinationGroupA11y: "Remove destination {{index}}",
    saveInfo: "Save info",
    destinationTitleLabel: "Destination title",
    destinationPageLabel: "Page number",
    destinationTitlePlaceholder: "Destination title",
    destinationPagePlaceholder: "e.g. 1",
    infoFieldLabel: "Info text",
    infoPlaceholder: "Info text...",
    createdLinksCount: "Created {{count}} links",
  },
  qrScannerScreen: {
    title: "QR Scanner",
